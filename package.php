...
<body>
    ...
    <section class="header">
        ...
        <nav class="navbar">
            ...
            <a href="package.php" class="nav-link"
                style="color: var(--main-color); border: solid 4px var(--main-color); border-radius: 1rem; padding: 10px;">Package</a>
    ...
    <div class="heading"
        style="background-image: url('assets/images/header-bg-2.png');">
        <h1>Package</h1>
    </div>

    <!-- Packages -->

    <section class="packages" style="position: relative; margin-bottom: 5rem;">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <p>
                        ...
                        elit.
                        Nihil, dolore deserunt eum reiciendis a enim dicta
                        ducimus omnis est porro?
                    </p>
